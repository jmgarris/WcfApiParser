...
public sealed class WrapperImplementationGenerator
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        builder.AppendLine("// Review generated comments for accuracy before publishing the package.");
        ...
        foreach (var operation in contract.Operations)
        {
            ...
            ReportProgress(options, DiagnosticSeverity.Info, $"Generating comment for {operation.MethodName}...");
            ...
            {
                ReportProgress(options, DiagnosticSeverity.Info, $"Copilot comment generated for {operation.MethodName}.");
            }
            else
            {
                var fallbackMessage = documentationResult.Diagnostics.Any(static diagnostic => diagnostic.Code == "COPILOT_FALLBACK")
                    ? $"Copilot failed for {operation.MethodName}; using fallback comment."
